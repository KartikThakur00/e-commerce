                        ...
                        {cart.map((item) => {
                            return (
                                <div key={item.id} class="flex flex-col rounded-lg bg-white sm:flex-row">
                                    <img class="m-2 h-24 w-28 rounded-md border object-contain object-center aspect-square" src={item.image} alt="" />
                    ...
                    <div class="">
                        ...
                        <div class="flex flex-col sm:flex-row">
                            <div class="relative flex-shrink-0 sm:w-7/12">
                                ...
                                <div class="pointer-events-none absolute inset-y-0 left-0 inline-flex items-center px-3">
                                    <img class="h-4 w-4 object-contain" src="https://flagpack.xyz/_nuxt/43d56f605a4ad41c190b7798a99c53bf.svg" alt="" />
                                </div>
                            </div>
